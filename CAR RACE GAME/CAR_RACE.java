...
import java.util.concurrent.TimeUnit;
	...
	public class CAR_RACE extends JFrame implements KeyListener,ActionListener	   
	{	   
		...
		public CAR_RACE(String title)	   // CONSTRUCTOR
		{	   
			super(title);	   
		...
		//-----------------------------------------------------------------
		//############## for  road ###################	      
		tree1=new ImageIcon("./CAR_RACE_IMG/tree1.png");	   
		tree1.paintIcon(this, g, 0, tree1ypos);	   
		num1=random.nextInt(500);	   
		tree1ypos+=50;	   
			   
		tree2=new ImageIcon("./CAR_RACE_IMG/tree2.png");	   
		tree2.paintIcon(this, g, 0,tree2ypos );	   
		tree2ypos+=50;	   
			   
		tree3=new ImageIcon("./CAR_RACE_IMG/tree3.png");	   
		...
		//-----------------------------------------------------------------  
			car=new ImageIcon("CAR_RACE_IMG/gamecar1.png");	      
			...
			//-----------------------------------------------------------------   
			//###############  opposite car	################   
			car1=new ImageIcon("CAR_RACE_IMG/gamecar2.png");	   
			car2=new ImageIcon("CAR_RACE_IMG/gamecar3.png");	   
			car3=new ImageIcon("CAR_RACE_IMG/gamecar4.png");	   
